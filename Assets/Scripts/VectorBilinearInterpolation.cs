...
public class VectorBilinearInterpolation : MonoBehaviour {

    public GameObject[] OriginBoxKeyPts;
    public GameObject[] TargetBoxKeyPts;
    public GameObject TestPtInput;
    public GameObject TestPtOutput;
    public GameObject TestMesh;

    private Vector3 a1, b1, c1, d1, e1, f1, g1, h1, t1, a2, b2, c2, d2, e2, f2, g2, h2, t2;
    private float u, v, w;
